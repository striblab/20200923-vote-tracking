		...
		new WebpackDeployer({
		  environments: {
		    staging: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/staging/news/projects/all/20200923-vote-tracking/build',
		    ...
		    production: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/news/projects/all/20200923-vote-tracking/build',
		        DistributionId: 'BUCKETIDHERE'
		      }
		    }
		  },
